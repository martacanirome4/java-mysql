...
public class Main {
    ...
    // Aray de consultas - para uso futuro
    /*
    ...
    */
    public static void main(String[] args) {
        try {
            ...
            double media_SAKILA1_1 = Tiempos.mediaTiempoConsulta(tiempos_SAKILA1_1);
            ...
            double media_SAKILA1_2 = Tiempos.mediaTiempoConsulta(tiempos_SAKILA1_2);
            ...
            double media_WORLD1_1 = Tiempos.mediaTiempoConsulta(tiempos_WORLD1_1);
            System.out.println("World (1) - Media de tiempo: " + media_WORLD1_1 + "(ms)");

            double[] tiempos_WORLD1_2 = MySQLHandler.consultasWorld(WORLD1_2);
            double media_WORLD1_2 = Tiempos.mediaTiempoConsulta(tiempos_WORLD1_2);
            ...
            double media_SAKILA2_1 = Tiempos.mediaTiempoConsulta(tiempos_SAKILA2_1);
            ...
            double media_SAKILA2_2 = Tiempos.mediaTiempoConsulta(tiempos_SAKILA2_2);
            ...
            double media_WORLD2_1 = Tiempos.mediaTiempoConsulta(tiempos_WORLD2_1);
            System.out.println("World (1) - Media de tiempo: " + media_WORLD2_1 + "(ms)");

            double[] tiempos_WORLD2_2 = MySQLHandler.consultasWorld(WORLD2_2);
            double media_WORLD2_2 = Tiempos.mediaTiempoConsulta(tiempos_WORLD2_2);
            ...
            double media_SAKILA3_1 = Tiempos.mediaTiempoConsulta(tiempos_SAKILA3_1);
            ...
            double media_SAKILA3_2 = Tiempos.mediaTiempoConsulta(tiempos_SAKILA3_2);
            ...
            double media_WORLD3_1 = Tiempos.mediaTiempoConsulta(tiempos_WORLD3_1);
            System.out.println("World (1) - Media de tiempo: " + media_WORLD3_1 + "(ms)");

            double[] tiempos_WORLD3_2 = MySQLHandler.consultasWorld(WORLD3_2);
            double media_WORLD3_2 = Tiempos.mediaTiempoConsulta(tiempos_WORLD3_2);
